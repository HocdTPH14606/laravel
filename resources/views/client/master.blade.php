...
<head>
    <meta charset="utf-8"> 
    <title>H & T - Online Shop Website Template</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">
    <!-- Favicon -->
    <link href="img/logo1.2.jpg" rel="icon">
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">H & T</span>
            ...
            <div class="col-lg-4 col-6 text-left">
                <form action="{{route('client.shop')}}" method="get">
                    <div class="input-group">
                        <input type="search" name="name" value="{{$name}}" class="form-control" placeholder="Search for products">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        @foreach ($rooms as $item) 
                            <a href="/productRoom/{{$item->id}}" class="nav-item nav-link">{{$item->name}}</a>
                        @endforeach
                    </div>
                </nav>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{route('client.client')}}" class="nav-item nav-link">Home</a>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="{{route('client.cart')}}" class="btn px-0 ml-3">
